                  ...
                  <div class="card mt-3">
                      <div class="card-body">
                        <div class="form-group">
                            ...
                            @error('layanan_nama') <small class="text-danger">{{ $message }}</small> @enderror
                        </div>
                        <div class="form-group">
                      ...
                      <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-2">
                                <input wire:model="barang" type="text" class="form-control" id="barang">
                        ...
                        <span class="badge badge-pill badge-primary pointer">Tambah</span>
                      </div>
                  </div>
